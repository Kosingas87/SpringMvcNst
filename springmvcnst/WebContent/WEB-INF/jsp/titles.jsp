        ...
        <div class="row content">
            <div id="sidebarleft" class="col-sm-2 sidenav container-fluid d-none d-sm-block">
               ...
               <div id="body" class="col-sm-8 text-left container-fluid ">
                <br>
                <h1>All titles for employees</h1>
                <br>
                ...
                <tbody>
                    <c:forEach var="title" items="${titles}">
                        <tr>
                            ...
                            <td><a onclick="if(!(confirm('Are u sure u want to delete? '))) return false" href="${pageContext.request.contextPath}/deletetitle?titlesId=${title.titlesId}">Delete</a>
                            </td>
