		...
		<div class="row content">
			...
			<div id="body" class="col-xlg-12  col-md-12 text-left col-12 col-lg-8  container-fluid ">
				...
				<form name="myformtitle" method="POST"
					action="${pageContext.request.contextPath}/doupdatetitle"
					onsubmit="return validateFormTitle()">
					<c:forEach var="title" items="${titles}">
						<div class="form-group row">
							<label for="titlesId" class="col-sm-2 col-form-label">Id:</label>
							<div class="col-sm-8">
								<input type="text" value="${title.titlesId}" class="form-control" name="titlesId"
						...
						<div class="form-group row">
							<label for="fromDate" class="col-sm-2 col-form-label">From
								date:</label>
							<div class="col-sm-8">
								<input type="text" value="${title.fromDate}" class="form-control" id="fromDate"
						...
						<div class="form-group row">
							<label for="toDate"  class="col-sm-2 col-form-label">To
								date:</label>
							<div class="col-sm-8">
								<input type="text" value="${title.toDate}" class="form-control" id="toDate"
						...
						<div class="form-group row">
							<div class="col-sm-10">
								<button type="submit" class="btn btn-primary">Update title
								</button>
							</div>
						</div>
					</c:forEach>
