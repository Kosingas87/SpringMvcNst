...
<h4 style="color:green;"> ${message}</h4>
                ...
                <form  name="myformdepartment" method="POST" action="${pageContext.request.contextPath}/doupdatedepartment" onsubmit="return validateFormDepartment()">
                        <c:forEach var="department" items="${departments}">
                        <div class="form-group row">
                        <label for="deptId" class="col-sm-2 col-form-label">Id:</label>
                        <div class="col-sm-8">
                            <input type="text" value="${department.deptId}" class="form-control" name="deptId" id="deptId" placeholder="number">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="deptName" class="col-sm-2 col-form-label">Department name:</label>
                        <div class="col-sm-8">
                            <input type="text" value="${department.deptName}" class="form-control" id="deptName" name="deptName" placeholder="Human Resources">
                        </div>
                    </div>
