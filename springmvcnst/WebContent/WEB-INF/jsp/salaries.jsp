    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div id="body" class="col-xlg-12  col-md-12 text-left col-12 col-lg-8  container-fluid ">
                <br>
                <h1>All salaries for employees</h1>
                <br>
...
<div class="table-responsive">
  ...
  <caption>List of salaries</caption>
  <thead>
                    <tr>
                          <th>ID</th>
                        <th>From date</th>                    
                ...
                <tbody>
                    <c:forEach var="salary" items="${salaries}">
                        <tr>
                            ...
                            <td><a onclick="if(!(confirm('Are u sure u want to delete? '))) return false"   href="${pageContext.request.contextPath}/deletesalaries?salariesId=${salary.salariesId}">Delete</a>
                            </td>
