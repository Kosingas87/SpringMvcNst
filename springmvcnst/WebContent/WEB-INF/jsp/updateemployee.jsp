...
<h4 style="color:green;"> ${message}</h4>
                ...
                <form  name="myform" method="POST" action="${pageContext.request.contextPath}/doupdate" onsubmit="return validateForm()">
                        <c:forEach var="employee" items="${employees}">
                        <div class="form-group row">
                        <label for="empId" class="col-sm-2 col-form-label">Id:</label>
                        <div class="col-sm-8">
                            <input type="text" value="${employee.empId}" class="form-control" name="empId" id="empId" placeholder="number">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="birthDate" class="col-sm-2 col-form-label">Birth date:</label>
                        <div class="col-sm-8">
                            <input type="text"  value="${employee.birthDate}" class="form-control" id="birthDate" name="birthDate" placeholder="yyyy-mm-dd">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="firstName" class="col-sm-2 col-form-label">First name:</label>
                        <div class="col-sm-8">
                            <input type="text"  value="${employee.firstName}"  class="form-control" id="firstName" name="firstName" placeholder="John">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lastName" class="col-sm-2 col-form-label">Last name:</label>
                        <div class="col-sm-8">
                            <input type="text"   value="${employee.lastName}" class="form-control" id="lastName" name="lastName"  placeholder="John">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="${employee.hireDate}" class="form-control" id="hireDate" name="hireDate" placeholder="yyyy-mm-dd">
                        </div>
                    </div>
