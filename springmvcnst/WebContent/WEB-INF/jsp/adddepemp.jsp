...
<body>
	...
	<form action="${pageContext.request.contextPath}/docreatedepemp"
		method="post">
		...
		<table class="formtable">
			...
			<tr>
				...
				<td class="control"><input name="deptEmpId" type="text">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="label"></td>
				<td class="control"><input type="submit" value="Add employee into department">
				</td>
			</tr>
